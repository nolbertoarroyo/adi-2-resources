...
//TODO: Create a SpotifyObject that mirrors the string
    Gson gson = new Gson();
    Stations stations = gson.fromJson(SPOTIFY_JSON,Stations.class);
    WheatherForcast wheatherForcast = gson.fromJson(WEATHER_JSON, WheatherForcast.class);
    ...
    String jsonMarvel = gson.toJson(MarvelResult.class);
